...
class Premise_Form_Class {
	...
	public function select_field() {
		$this->html_markup .= '<div class="select">';
	...
	/**
	 * @param  array $this->field options
	 * @return $this->html_markup         html markup for label
	 */
	public function the_label() {
		...
		if( 'checkbox' == $this->field['type'] || 'radio' == $this->field['type'] ) {
			$this->html_markup .= '<p class="label">'.$this->field['label'].'</p>';
		}
		else{
			$this->html_markup .= '<label for="'.$this->field['id'].'">'.$this->field['label'].'</label>';
		}
	...
	/**
	 * @param  array $this->field options
	 * @return $this->html_markup         html markup for tooltip if any
	 */
	public function the_tooltip() {
		if( $this->field['tooltip'] )
			$this->html_markup .= '<span class="tooltip"><i>'.$this->field['tooltip'].'</i></span>';
	}
